...
ver.1.3.b -  add DHT sensor for temperature & humidity, 21 october 2018, Craiova - Romania
***********************************************************************/
...
int b = 0;
int bmax = 200;  // 1000 = aprox 6 sec
int amax = 150;    // 20 = 1 sec
void setup() {
